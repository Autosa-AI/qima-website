          ...
          <div className="rounded-3xl border border-white/[0.08] bg-white/[0.02] p-7 overflow-hidden relative">
            ...
            <div className={`relative z-10 ${isRTL ? "font-arabic" : ""}`}>
              ...
              <a
                ...
                className="group relative flex items-center justify-center gap-2 w-full px-6 py-4 bg-gold text-black font-bold rounded-2xl overflow-hidden transition-all hover:shadow-[0_0_30px_rgba(201,168,76,0.4)] hover:scale-[1.02] active:scale-[0.98] text-sm"
              >
