          ...
          >
            <div className="relative rounded-3xl border border-white/[0.08] bg-white/[0.02] p-6 overflow-hidden">
              ...
              <div className={`relative z-10 ${isRTL ? "font-arabic" : ""}`}>
                ...
                <AnimatePresence>
                  {selectedAmount === "custom" && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="mb-4 overflow-hidden">
                      <input type="number" placeholder={isRTL ? "أدخل المبلغ (جنيه)" : "Enter amount (EGP)"}
                ...
                {/* CTA */}
                <button className="group relative w-full px-6 py-3.5 bg-gold text-black font-bold rounded-2xl overflow-hidden transition-all hover:shadow-[0_0_28px_rgba(201,168,76,0.4)] hover:scale-[1.02] active:scale-[0.98] text-sm">
